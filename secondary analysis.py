...
algorithmic_trigger_terms = [
    "echo chamber", "filter bubble", "black box", "black-box"
]
    ...
    if filename.endswith(".pdf") and not filename.startswith('.'):
        ...
        try:
            ...
            result = {
                ...
                "Associated Descriptors Trigger Count": total_trigger_count
            }
...
# Export to Excel
output_path = os.path.join("/Volumes/WallyWest/Corpus_Analysis_AssociatedDescriptors.xlsx")
